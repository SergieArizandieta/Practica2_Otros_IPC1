...
public class operaciones {
    ...
    public  static void DoubleNextT1(){
        int T1auxDisc = 0;
        int T1Large = 0;
        int T1posiX = 0;
        int auxPosicion = 0;
        ...
        for (int i=6;i>=0;i--){
            if (T3[i].getDisco() ==0){
                if (i != 6){
                    if(T3[i+1].getDisco()> T1auxDisc){
                        T1aT3( i, T1posiX, T1auxDisc, T1Large, auxPosicion);
                    }
                }else if(i==6){
                   T1aT3( i, T1posiX, T1auxDisc, T1Large, auxPosicion);
                }
    ...
    public  static void DoubleBack3(){
        int T3auxDisc = 0;
        int T3Large = 0;
        int T3posiX = 0;
        int auxPosicion = 0;
        ...
        for (int i=6;i>=0;i--){
            if (T1[i].getDisco() ==0){
                if (i != 6){             
                    if(T1[i+1].getDisco()> T3auxDisc){
                        T3aT1( i, T3posiX, T3auxDisc, T3Large, auxPosicion);
                    }
                }else if(i==6){
                   T3aT1( i, T3posiX, T3auxDisc, T3Large, auxPosicion);
                }
            ...
            if(T3[i].getDisco() !=0){
                if(i==6){
                   ...
                   contador =1;
                    ...
                    if(auxVerificador>T3[i].getDisco()){
                        auxVerificador = T3[i].getDisco();
                        contador+=1;
    ...
    //Refrescar la posicion de los discos
